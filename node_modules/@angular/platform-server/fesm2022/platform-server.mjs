...
function provideServerRendering(options) {
  ...
  if (options?.maxResponseBodySize) {
    providers.push({
      provide: _HTTP_FETCH_MAX_RESPONSE_SIZE,
  ...
  if (typeof url === 'string') {
    ...
    if (parsedUrl !== null) {
      ...
      if (!isHostAllowed(hostname, allowedHostsSet)) {
        throw new _RuntimeError(5706, typeof ngDevMode === 'undefined' || ngDevMode ? `Host ${url} is not allowed. You can configure \`allowedHosts\` option.` : url);
      }
    }
  }
}
...
const VERSION = /* @__PURE__ */new Version('22.1.7');
