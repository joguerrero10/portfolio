...
import { InjectionToken, inject, input, numberAttribute, booleanAttribute, computed, ChangeDetectionStrategy, Component, Injector, Renderer2, PLATFORM_ID, ElementRef, effect, HostAttributeToken, runInInjectionContext, Inject, NgModule } from '@angular/core';
...
class NgGlyph {
    constructor() {
         ...
         */
        this.glyphset = input(this.glyphsets.defaultGlyphset, /* @ts-ignore */
        ...(ngDevMode ? [{ debugName: "glyphset" }] : /* istanbul ignore next */ []));
        /**
         * Define the optical size of the glyph
         */
        this.opticalSize = input(this.config.opticalSize, { ...(ngDevMode ? { debugName: "opticalSize" } : /* istanbul ignore next */ {}), transform: numberAttribute });
        /**
         * Define the weight of the glyph
         */
        this.weight = input(this.config.weight, { ...(ngDevMode ? { debugName: "weight" } : /* istanbul ignore next */ {}), transform: numberAttribute });
        /**
         * Define the grade of the glyph
         */
        this.grade = input(this.config.grade, { ...(ngDevMode ? { debugName: "grade" } : /* istanbul ignore next */ {}), transform: numberAttribute });
        /**
         * Define the fill of the glyph
         */
        this.fill = input(this.config.fill, { ...(ngDevMode ? { debugName: "fill" } : /* istanbul ignore next */ {}), transform: booleanAttribute });
        /**
         * Define the size of the glyph
         */
        this.size = input(this.config.size, { ...(ngDevMode ? { debugName: "size" } : /* istanbul ignore next */ {}), transform: coerceCssPixelValue });
        /**
         * Define the color of the glyph
         */
        this.color = input(this.config.color, /* @ts-ignore */
...
function postprocessIcon(element) {
    ...
    const elements = [
        ...
        ...Array.from(element.querySelectorAll('[data-style]')),
    ];
...
class NgIconsModule {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.7", ngImport: i0, type: NgIconsModule, deps: [{ token: NgIconsToken }], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "22.0.7", ngImport: i0, type: NgIconsModule, imports: [NgIcon], exports: [NgIcon] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "22.0.7", ngImport: i0, type: NgIconsModule }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.7", ngImport: i0, type: NgIconsModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [NgIcon],
                    exports: [NgIcon],
...
class NgIconStack {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.7", ngImport: i0, type: NgIconStack, deps: [], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.1.0", version: "22.0.7", type: NgIconStack, isStandalone: true, selector: "ng-icon-stack", inputs: { size: { classPropertyName: "size", publicName: "size", isSignal: true, isRequired: true, transformFunction: null } }, host: { properties: { "style.--ng-icon__size": "size()" } }, ngImport: i0, template: '<ng-content />', isInline: true, styles: [":host{display:inline-flex;justify-content:center;align-items:center;position:relative;width:var(--ng-icon__size);height:var(--ng-icon__size)}:host ::ng-deep ng-icon{position:absolute}\n"], changeDetection: i0.ChangeDetectionStrategy.OnPush }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.7", ngImport: i0, type: NgIconStack, decorators: [{
            type: Component,
