...
exports.getRecommendedAngularMajor = getRecommendedAngularMajor;
exports.formatAngularVersionMismatchError = formatAngularVersionMismatchError;
...
const ANGULAR_VERSION_SUPPORT_DOCS_URL = 'https://github.com/angular-eslint/angular-eslint/blob/main/docs/ANGULAR_VERSION_SUPPORT.md';
function formatAngularVersionMismatchDetails(expectedMajor, mismatches) {
 ...
 */
function getRecommendedAngularMajor(mismatches) {
 ...
 */
function formatAngularVersionMismatchError(expectedMajor, mismatches) {
