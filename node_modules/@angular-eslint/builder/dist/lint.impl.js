...
const angular_version_compat_1 = require("./utils/angular-version-compat");
const eslint_utils_1 = require("./utils/eslint-utils");
const report_angular_version_compat_1 = require("./utils/report-angular-version-compat");
const requireFromModule = (0, node_module_1.createRequire)(__filename);
const { version: builderVersion } = requireFromModule('../package.json');
exports.default = (0, architect_1.createBuilder)(async (options, context) => {
    try {
        ...
        const expectedMajor = (0, angular_version_compat_1.parseMajorVersion)(builderVersion);
        if (expectedMajor !== null) {
            (0, report_angular_version_compat_1.reportAngularVersionCompatibility)(systemRoot, expectedMajor, (message) => {
