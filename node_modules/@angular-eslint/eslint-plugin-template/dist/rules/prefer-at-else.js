...
exports.default = (0, create_eslint_rule_1.createESLintRule)({
    ...
    create(context) {
        ...
        function wouldPreventContentProjection(nodes) {
            let rootNodeCount = 0;
            let hasProjectableNode = false;
            for (const node of nodes) {
                if (node instanceof bundled_angular_compiler_1.TmplAstText &&
                ...
                rootNodeCount++;
                hasProjectableNode ||=
                    node instanceof bundled_angular_compiler_1.TmplAstElement || node instanceof bundled_angular_compiler_1.TmplAstTemplate;
            }
